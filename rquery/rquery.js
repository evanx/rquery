...
export default class {
   ...
   async handleTelegramSignup(request) {
      ...
      await this.sendTelegram(request.chatId, 'html', [
         ...
         `Please try the bash commands generated by the following link to create a client cert:`,
      ...
      this.addPublicCommand({
         ...
         this.addKeyspaceCommand({
            ...
            const description = [`You can set, add and view keys, sets, lists, zsets, hashes etc.` +
               ...
               ` You can also try changing to 'replica.redishub.com' domain to read keys.` +
