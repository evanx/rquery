...
export default class Metrics {
   ...
   async start() {
      this.redisNamespace = Asserts.assert(config.serviceNamespace, 'serviceNamespace');
      this.redisClient = service.createRedisClient(Asserts.assert(config.serviceRedis, 'serviceRedis'));
