...
exports.default = function (props) {
   ...
   return Object.assign(props, {
      ...
      content: lodash.flatten([He.p({}, props.result.message.join(' ')), '<h3>Basic</h3>', renderUrls(props.result.common), '<h3>Ephemeral</h3>', renderPaths(props.result.ephemeral), '<h3>Miscellaneous</h3>', renderPaths(props.result.misc), '<h3>Telegram</h3>', renderPaths(props.result.telegram), renderAccount(props.result.account), '<h3>Account keyspace</h3>', renderPaths(props.result.accountKeyspace)]).join('\n')
   });
};
