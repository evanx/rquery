            ...
            while (1) {
               switch (_context2.prev = _context2.next) {
                  case 0:
                     ...
                     messages = account ? messages.push($.a({ href: '/keyspaces/' + account }, 'List the keyspaces on your account')) : [$.a({ href: '/about' }, 'About ' + rquery.config.serviceLabel), $.a({ href: '/create-ephemeral' }, 'Create a ephemeral keyspace via /create-ephemeral'), $.a({
                        target: '_blank',
