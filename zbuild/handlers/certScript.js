         ...
         while (1) {
            switch (_context.prev = _context.next) {
               ...
               case 8:
                  ...
                  result = ['', 'Curl this script and pipe into bash as follows:', '', 'curl -s ' + serviceUrl + '/' + commandKey + '/' + account + ' | bash', ''].map(function (line) {
                     return '# ' + line;
                  });
