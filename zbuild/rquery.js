...
var rquery = function () {
   ...
   _createClass(rquery, [{
               ...
               while (1) {
                  switch (_context12.prev = _context12.next) {
                     ...
                     case 19:
                        ...
                        _context12.next = 22;
                        return this.sendTelegram(request.chatId, 'html', ['Thanks, ' + request.greetName + '.', 'Your ' + this.config.serviceLabel + ' account name is <b>' + account + '</b>, as per your Telegram user.', 'Use the /login command here anytime to get a magic web login link.', 'Also, you can use the following script create a client cert:', this.config.openHostname + '/cert-script/' + account + '.']);
      ...
      value: function getHref(req, url) {
         this.logger.debug('getHref', url, this.getBotUrl(req));
