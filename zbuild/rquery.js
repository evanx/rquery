                  ...
                  while (1) {
                     switch (_context24.prev = _context24.next) {
                        case 0:
                           ...
                           exampleUrls = [hostUrl + '/ak/' + account + '/' + keyspace + '/set/mykey/myvalue', hostUrl + '/ak/' + account + '/' + keyspace + '/get/mykey', hostUrl + '/ak/' + account + '/' + keyspace + '/set/myjsonlist1/[1,2,3]', hostUrl + '/ak/' + account + '/' + keyspace + '/getjson/myjsonlist1', hostUrl + '/ak/' + account + '/' + keyspace + '/setjsonquery/myobject1?name=myname&age=42', hostUrl + '/ak/' + account + '/' + keyspace + '/setjsonobject/myobject2/name:"myname",age:42', hostUrl + '/ak/' + account + '/' + keyspace + '/getjson/myobject1', hostUrl + '/ak/' + account + '/' + keyspace + '/getjson/myobject2', hostUrl + '/ak/' + account + '/' + keyspace + '/sadd/myset/myvalue', hostUrl + '/ak/' + account + '/' + keyspace + '/smembers/myset', hostUrl + '/ak/' + account + '/' + keyspace + '/lpush/mylist/myvalue', hostUrl + '/ak/' + account + '/' + keyspace + '/lrange/mylist/0/10', hostUrl + '/ak/' + account + '/' + keyspace + '/rrange/mylist/0/10', hostUrl + '/ak/' + account + '/' + keyspace + '/hset/hashes1/field1/value1', hostUrl + '/ak/' + account + '/' + keyspace + '/hsetnx/hashes1/field2/value2', hostUrl + '/ak/' + account + '/' + keyspace + '/hgetall/hashes1', hostUrl + '/ak/' + account + '/' + keyspace + '/zadd/zset1/10/member10', hostUrl + '/ak/' + account + '/' + keyspace + '/zadd/zset1/20/member20', hostUrl + '/ak/' + account + '/' + keyspace + '/zrange/zset1/0/-1', hostUrl + '/ak/' + account + '/' + keyspace + '/zrevrange/zset1/0/-1', hostUrl + '/ak/' + account + '/' + keyspace + '/ttls'];
