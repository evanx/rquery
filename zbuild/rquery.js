...
var _class = function () {
   ...
   _createClass(_class, [{
      ...
      value: function () {
         var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee8(request, format) {
            var _len,
                content,
                _key,
                _args8 = arguments;
               ...
               while (1) {
                  switch (_context8.prev = _context8.next) {
                     case 0:
                        ...
                        for (_len = _args8.length, content = Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
                           content[_key - 2] = _args8[_key];
                        }
      ...
      value: function () {
         var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee9(account, format) {
         ...
         function sendTelegramAlert(_x10, _x11) {
            return ref.apply(this, arguments);
         }
      ...
      key: 'sendTelegram',
      value: function () {
         var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee10(chatId, format) {
         ...
         function sendTelegram(_x12, _x13) {
            return ref.apply(this, arguments);
         }
      ...
      value: function addRoutes() {
         ...
         this.addPublicCommand({
            ...
            sendResult: function () {
               var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee11(req, res, reqx, result) {
               ...
               function sendResult(_x14, _x15, _x16, _x17) {
                  return ref.apply(this, arguments);
               }
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee12(req, res, reqx) {
                  ...
                  while (1) {
                     switch (_context15.prev = _context15.next) {
                        ...
                        case 12:
                           ...
                           return _context15.abrupt('return', _this5.listCommands());
         ...
         this.addPublicRoute('epoch', (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee17() {
            var time;
         ...
         this.addPublicRoute('time/seconds', (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee18() {
            var time;
         ...
         this.addPublicRoute('time/milliseconds', (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee19() {
            var time;
               ...
               while (1) {
                  switch (_context19.prev = _context19.next) {
                     ...
                     case 2:
                        ...
                        return _context19.abrupt('return', Math.ceil(time[0] * 1000 + time[1] / 1000));
         ...
         this.addPublicRoute('time/nanoseconds', (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee20() {
            var time;
               ...
               while (1) {
                  switch (_context20.prev = _context20.next) {
                     ...
                     case 2:
                        ...
                        return _context20.abrupt('return', Math.ceil(time[0] * 1000 * 1000 + parseInt(time[1])));
                  ...
                  while (1) {
                     switch (_context21.prev = _context21.next) {
                        case 0:
                           ...
                           return _context21.abrupt('return', _this5.buildQrReply({ user: user, host: host }));
                  ...
                  while (1) {
                     switch (_context22.prev = _context22.next) {
                        case 0:
                           ...
                           return _context22.abrupt('return', _this5.buildQrReply({ account: address, issuer: issuer }));
         ...
         if (!this.config.secureDomain) {
            ...
            this.addPublicCommand({
               ...
               var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee23(req, res, reqx) {
                  var account, accountKey, _ref11, _ref12, _ref12$, time, registered, admined, accessed, certs, duration, token;
                     ...
                     while (1) {
                        switch (_context23.prev = _context23.next) {
                           ...
                           case 4:
                              ...
                              return _context23.abrupt('return', 'Admin command interval not elapsed: ' + _this5.config.adminLimit + 's');
                           ...
                           case 20:
                              return _context23.abrupt('return', token);
         ...
         this.addPublicCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee24(req, res) {
               var user, userKey, _ref13, _ref14, _ref14$, now, sismember, verified, secret, duration;
                  ...
                  while (1) {
                     switch (_context24.prev = _context24.next) {
                        ...
                        case 4:
                           ...
                           return _context24.abrupt('return', 'OK: ' + user + '@telegram.me, verified ' + Millis.formatVerboseDuration(duration) + ' ago');

                        case 17:
                           return _context24.abrupt('return', 'OK: ' + user + '@telegram.me');
                        ...
                        case 20:
                           return _context24.abrupt('return', 'Telegram user not yet verified: ' + user + '. Please Telegram \'@redishub_bot /verify_me\' e.g. via https://web.telegram.org');
         ...
         this.addKeyspaceCommand({
            ...
            resultObjectType: 'KeyedArrays',
            sendResult: function () {
               var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee25(req, res, reqx, result) {
                  ...
                  while (1) {
                     switch (_context26.prev = _context26.next) {
                        case 0:
                           ...
                           return _context26.abrupt('return', { message: message, commandReferenceMessage: commandReferenceMessage, customCommandHeading: customCommandHeading, description: description, exampleUrls: exampleUrls,
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee27(req, res, reqx) {
               var time, account, keyspace, accountKey, _ref15, _ref16, hsetnx;
                  ...
                  while (1) {
                     switch (_context27.prev = _context27.next) {
                        case 0:
                           ...
                           _this5.logger.debug('hsetnx', accountKey, time, Object.keys(reqx));
                           _context27.next = 8;
                           return _this5.redis.multiExecAsync(function (multi) {
                        ...
                        case 8:
                           ...
                           _context27.next = 14;
                           return _this5.sendTelegramAlert(reqx.account, 'html', 'Registered new keyspace <code>' + reqx.keyspace + '</code>');

                        case 14:
                           return _context27.abrupt('return', 'OK');
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee28(req, res, _ref17) {
               var account = _ref17.account;
               var keyspace = _ref17.keyspace;
               var accountKey = _ref17.accountKey;
               var keyspaceKey = _ref17.keyspaceKey;

               var _ref18, _ref19, keys, _ref20, _ref21, keyspaces, keyIndex, multiReply;
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee36(req, res, _ref22) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee41(req, res, _ref23) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee44(req, res, _ref24) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee46(req, res, _ref25) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee47(req, res, _ref26) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee49(req, res, _ref27) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee50(req, res, _ref28, multi) {
               var account = _ref28.account;
               var keyspace = _ref28.keyspace;
            ...
            return function (_x113, _x114, _x115, _x116) {
               return ref.apply(this, arguments);
            };
         }());
         this.addKeyspaceCommand({
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee57(req, res, _ref29, multi) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee63(req, res, _ref30, multi) {
                  ...
                  while (1) {
                     switch (_context91.prev = _context91.next) {
                        ...
                        case 15:
                           ...
                           _this6.sendError(req, res, _context91.t0);
                  ...
                  while (1) {
                     switch (_context92.prev = _context92.next) {
                        ...
                        case 9:
                           ...
                           _this7.sendError(req, res, _context92.t0);
               ...
               return regeneratorRuntime.wrap(function _callee94$(_context94) {
                  while (1) {
                     switch (_context94.prev = _context94.next) {
                        case 0:
                           req.params = { account: 'hub' };
                           return _context94.abrupt('return', _this8.registerEphemeral(req, res));
               ...
               return regeneratorRuntime.wrap(function _callee95$(_context95) {
                  while (1) {
                     switch (_context95.prev = _context95.next) {
                        case 0:
                           req.params.account = 'hub';
                           return _context95.abrupt('return', _this8.registerEphemeral(req, res));
               ...
               return regeneratorRuntime.wrap(function _callee96$(_context96) {
                  while (1) {
                     switch (_context96.prev = _context96.next) {
                        case 0:
                           return _context96.abrupt('return', _this8.registerAccount(req, res));
      ...
      value: function addAccountRoutes() {
         ...
         if (this.config.secureDomain) {
            this.addAccountCommand({
               ...
               var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee98(req, res, _ref31) {
                  var account = _ref31.account;
                  var accountKey = _ref31.accountKey;
                  var time = _ref31.time;
                  var clientCertDigest = _ref31.clientCertDigest;

                  var _ref32, _ref33, cert;
      ...
      value: function () {
                  ...
                  switch (_context100.prev = _context100.next) {
                     case 0:
                        ...
                        return _context100.delegateYield(regeneratorRuntime.mark(function _callee99() {
                           var errorMessage, account, v, dn, clientCert, clientCertDigest, otpSecret, accountKey, _ref34, _ref35, hsetnx, saddAccount, saddCert, result;
                           ...
                           return regeneratorRuntime.wrap(function _callee99$(_context99) {
                              while (1) {
                                 switch (_context99.prev = _context99.next) {
                                    ...
                                    case 18:
                                       _ref34 = _context99.sent;
                                       _ref35 = _slicedToArray(_ref34, 3);
                                       hsetnx = _ref35[0];
                                       saddAccount = _ref35[1];
                                       saddCert = _ref35[2];
                     ...
                     case 2:
                        ...
                        return _context100.abrupt('return', _ret.v);
                     ...
                     case 7:
                        ...
                        this.sendError(req, res, _context100.t1);
         ...
         function registerAccount(_x256, _x257) {
            return ref.apply(this, arguments);
         }
      ...
      value: function () {
         var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee103(command, fn) {
            var _this12 = this;
                              ...
                              return regeneratorRuntime.wrap(function _callee102$(_context102) {
                                 while (1) {
                                    switch (_context102.prev = _context102.next) {
                                       case 0:
                                          _context102.prev = 0;
                                          return _context102.delegateYield(regeneratorRuntime.mark(function _callee101() {
                                             var message, account, accountKey, _ref36, _ref37, _ref37$, time, admined, certs, duration, dn, result;
                                             ...
                                             return regeneratorRuntime.wrap(function _callee101$(_context101) {
                                                while (1) {
                                                   switch (_context101.prev = _context101.next) {
                                                      ...
                                                      case 7:
                                                         _ref36 = _context101.sent;
                                                         _ref37 = _slicedToArray(_ref36, 3);
                                                         _ref37$ = _slicedToArray(_ref37[0], 1);
                                                         time = _ref37$[0];
                                                         admined = _ref37[1];
                                                         certs = _ref37[2];
                                       ...
                                       case 7:
                                          ...
                                          _this12.sendError(req, res, _context102.t1);
         ...
         function addAccountCommand(_x258, _x259) {
            return ref.apply(this, arguments);
         }
      ...
      value: function () {
         var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee105(req, res, previousError) {
            var _this13 = this;
               ...
               while (1) {
                  switch (_context105.prev = _context105.next) {
                     ...
                     case 16:
                        ...
                        return _context105.abrupt('return', _ret3.v);
                     ...
                     case 21:
                        _context105.prev = 21;
                        _context105.t1 = _context105['catch'](14);

                        this.sendError(req, res, _context105.t1);
            ...
            }, _callee105, this, [[14, 21]]);
         }));

         function registerEphemeral(_x263, _x264, _x265) {
            return ref.apply(this, arguments);
         }
                     ...
                     switch (_context107.prev = _context107.next) {
                        case 0:
                           ...
                           return _context107.delegateYield(regeneratorRuntime.mark(function _callee106() {
                              var _req$params11, account, keyspace, key, timeout, accountKey, helpPath, reqx, v, isSecureAccount, _ref38, _ref39, _ref39$, time, registered, admined, accessed, certs, hostname, hostHashes, multi, result, _expire, _ref40, _ref41, expire;
                              ...
                              return regeneratorRuntime.wrap(function _callee106$(_context106) {
                                 while (1) {
                                    switch (_context106.prev = _context106.next) {
                                       ...
                                       case 32:
                                          _ref38 = _context106.sent;
                                          _ref39 = _slicedToArray(_ref38, 5);
                                          _ref39$ = _slicedToArray(_ref39[0], 1);
                                          time = _ref39$[0];
                                          registered = _ref39[1];
                                          admined = _ref39[2];
                                          accessed = _ref39[3];
                        ...
                        case 2:
                           ...
                           return _context107.abrupt('return', _ret4.v);
                        ...
                        case 7:
                           ...
                           _this14.sendError(req, res, _context107.t1);
      ...
      key: 'migrateKeyspace',
      value: function () {
         var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee108(_ref42) {
            var account = _ref42.account;
            var keyspace = _ref42.keyspace;

            var accountKey, _ref43, _ref44, accessToken, token, _ref45, _ref46, hsetnx, hdel;
            ...
            return regeneratorRuntime.wrap(function _callee108$(_context108) {
               while (1) {
                  switch (_context108.prev = _context108.next) {
                     ...
                     case 3:
                        _ref43 = _context108.sent;
                        _ref44 = _slicedToArray(_ref43, 2);
                        accessToken = _ref44[0];
                        token = _ref44[1];
         ...
         function migrateKeyspace(_x268) {
            return ref.apply(this, arguments);
         }
      ...
      key: 'validateAccess',
      value: function validateAccess(req, reqx, _ref47) {
         var certs = _ref47.certs;
      ...
      key: 'sendResult',
      value: function () {
         var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee109(command, req, res, reqx, result) {
               ...
               while (1) {
                  switch (_context109.prev = _context109.next) {
                     ...
                     case 48:
                        ...
                        return _context109.abrupt('return', this.sendHtmlResult(command, req, res, reqx, result));
         ...
         function sendResult(_x269, _x270, _x271, _x272, _x273) {
            return ref.apply(this, arguments);
         }
