   ...
   _createClass(rquery, [{
                     ...
                     case 0:
                        ...
                        this.expressApp.use(function (req, res, next) {
                           ...
                           if (_this.config.serviceKey === 'development') {
                              ...
                              res.redirect(302, 'https://' + _this.config.hostDomain + req.url);
                           } else {
                              next();
                           }
                        });
      ...
      value: function addRoutes() {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee26(req, res, reqx) {
               var command, time, account, keyspace, accountKey, _ref19, _ref20, sadd, _ref21, _ref22, hsetnx;
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee28(req, res, _ref25) {
               var account = _ref25.account;
               var keyspace = _ref25.keyspace;
               var accountKey = _ref25.accountKey;
               var keyspaceKey = _ref25.keyspaceKey;

               var _ref26, _ref27, keys, _ref28, _ref29, keyspaces, keyIndex, multiReply;
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee36(req, res, _ref30) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee44(req, res, _ref32) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee46(req, res, _ref33) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee47(req, res, _ref34) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee49(req, res, _ref35) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee50(req, res, _ref36, multi) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee57(req, res, _ref37, multi) {
         ...
         this.addKeyspaceCommand({
            ...
            var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee63(req, res, _ref38, multi) {
      ...
      value: function () {
         var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee99(req, res, reqx) {
            ...
            var cert, dn, _dn$cn$split, _dn$cn$split2, matching, account, role, id, accountKey, grantKey, certDigest, shortDigest, pemExtract, _ref39, _ref40, granted, sismember, _ref41, _ref42, del, sadd;
            ...
            return regeneratorRuntime.wrap(function _callee99$(_context99) {
               while (1) {
                  switch (_context99.prev = _context99.next) {
                     ...
                     case 19:
                        accountKey = this.adminKey('account', account);
                        grantKey = this.adminKey('telegram', 'user', account, 'grantcert');
                        certDigest = this.digestPem(cert);
                        shortDigest = certDigest.slice(-12);
                        pemExtract = this.extractPem(cert);
                        _context99.next = 26;
                        return this.redis.multiExecAsync(function (multi) {
                           multi.get(grantKey);
                           multi.sismember(_this10.adminKey('account', account, 'certs'), certDigest);
                        });

                     case 26:
                        _ref39 = _context99.sent;
                     ...
                     case 36:
                        ...
                        return this.redis.multiExecAsync(function (multi) {
                           multi.del(grantKey);
                           multi.sadd(_this10.adminKey('account', account, 'certs'), certDigest);
                        });

                     case 38:
                        _ref41 = _context99.sent;
         ...
         function registerCert(_x254, _x255, _x256) {
            return ref.apply(this, arguments);
         }
      ...
      value: function addAccountRoutes() {
         ...
         if (this.config.secureDomain) {
            this.addAccountCommand({
               ...
               var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee100(req, res, _ref43) {
               ...
               return function (_x257, _x258, _x259) {
                  return ref.apply(this, arguments);
               };
            }());
         }
      ...
      value: function () {
                           ...
                           return regeneratorRuntime.wrap(function _callee101$(_context101) {
                              while (1) {
                                 switch (_context101.prev = _context101.next) {
                                    ...
                                    case 25:
                                       if (!saddAccount) {
                                          _this13.logger.error('sadd account');
                                       }
                                       if (!saddCert) {
                                          _this13.logger.error('sadd cert');
                                       }
         ...
         function createAccount(_x260, _x261) {
            return ref.apply(this, arguments);
         }
      ...
      value: function () {
         ...
         function addAccountCommand(_x262, _x263) {
            return ref.apply(this, arguments);
         }
      ...
      value: function () {
                              ...
                              while (1) {
                                 switch (_context106.prev = _context106.next) {
                                    ...
                                    case 5:
                                       ...
                                       _this15.logger.debug('createEphemeral clientIp', clientIp, account, keyspace, accountKey);
                                       _context106.next = 10;
         ...
         function createEphemeral(_x267, _x268, _x269) {
            return ref.apply(this, arguments);
         }
                  ...
                  while (1) {
                     switch (_context109.prev = _context109.next) {
                                 ...
                                 while (1) {
                                    switch (_context108.prev = _context108.next) {
                                       case 0:
                                          ...
                                          accountKey = _this16.accountKeyspace(account, keyspace);
                        ...
                        case 7:
                           ...
                           _this16.sendError(req, res, _context109.t1);
      ...
      key: 'migrateKeyspace',
      value: function () {
         var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee110(_ref54) {
         ...
         function migrateKeyspace(_x272) {
            return ref.apply(this, arguments);
         }
      ...
      value: function sendStatusMessage(req, res, statusCode, err) {
         ...
         if (lodash.isString(err)) {
            ...
            if (err.stack) {
               if (err.name === 'ValidationError') {} else {
      ...
      key: 'end',
      value: function () {
         var ref = (0, _bluebird.coroutine)(regeneratorRuntime.mark(function _callee111() {
